...
const Item = ({ item }) => {
    ...
    return (
        <div className='mx-3 mt-5 p-4'>
            <MDBCard className='card shadow h-100'>
                <div style={{
                    height: '110px'
                }}>
                    <div className="p-5">
                ...
                <MDBCardBody>
                    ...
                    <MDBCardText>
                        <div className="short-desc row row-cols-1 row-cols-lg-3">
                            <h5 className='text-center border-right'>  <MDBIcon fas icon="tachometer-alt" className='me-2 text-danger' />{speed}K</h5>

                            <h5 className='text-center'>  <MDBIcon fas icon="cogs" className='me-2 text-danger' />{gear}</h5>
                            <h5 className='text-center border-left'>  <MDBIcon fas icon="gas-pump" className='me-2 text-danger' />{fuel}</h5>
                        </div>
